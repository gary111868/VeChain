...
#[derive(Debug)]
pub struct VeChainThorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl VeChainThorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting VeChainThor processing");
    
    let mut processor = VeChainThorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = VeChainThorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = VeChainThorProcessor::new(false);
